    ...
    if image is not None:
       ...
       if (image.shape == (64,64,3)):
          ...
          if (classif == 5):
             ...
             st.write('The model believes that this is an abnormal mitotic figure.')
             if st.button('Click for further explanation'):
...
def main():
     ...
     link0 = '[Repository With Our Code](https://github.com/rajivvelury/Mitotic_Subclassifier_FourthBrain_MLE9)'
     ...
     st.sidebar.markdown(link0, unsafe_allow_html=True)
     ...
     tab2.write('Please upload a 64 px X 64 px RGB image of a mitotic figure (MF) or mitotic-like figure (MLF) to see the likely subclassification.  The subclassifier will not work if the image is not of these dimensions.  Additionally, please only upload a relevant image-- an irrelevant image will also produce a label, but that label will be nonsense if the uploaded image is not of an MF or MLF.  Garbage in, garbage out!')
